...
class BaseButton extends StatefulWidget {
  ...
  BaseButton({
    ...
    this.forceState,
        ...
        textStyle = textStyle ?? TextStyle(fontSize: 14, fontWeight: FontWeight.w400),
        assert(
          text != null || icon != null,
...
class Buttons {
  ...
  static BaseButton ghost({
    ...
    Color? focusBackgroundColor =
        const Color(0xFF1D2939), // Dark gray background when focused
    ...
    Color? focusRingColor =
        const Color(0xFF98A2B3), // Focus ring color from palette
    double focusRingWidth = 3.0,
    bool underlineText = false,
    TextStyle? textStyle, // Uses TextStyle(fontSize: 14, fontWeight: FontWeight.w400) by default
  ...
  static BaseButton outline({
    ...
    Color? disabledBorderColor,
    Color textColor =
        const Color(0xFFFFFFFF), // White text for outline buttons when not specified
