...
class UnpingColorExtension extends ThemeExtension<UnpingColorExtension> {
  ...
  static const light = UnpingColorExtension(
    primary25: UnpingColors.primary25,
    primary50: UnpingColors.primary50,
    primary100: UnpingColors.primary100,
    primary200: UnpingColors.primary200,
    primary300: UnpingColors.primary300,
    primary400: UnpingColors.primary400,
    primary500: UnpingColors.primary500,
    primary600: UnpingColors.primary600,
    primary700: UnpingColors.primary700,
    primary800: UnpingColors.primary800,
    primary900: UnpingColors.primary900,
    primary950: UnpingColors.primary950,
    neutral25: UnpingColors.neutral25,
    neutral50: UnpingColors.neutral50,
    neutral100: UnpingColors.neutral100,
    neutral200: UnpingColors.neutral200,
    neutral300: UnpingColors.neutral300,
    neutral400: UnpingColors.neutral400,
    neutral500: UnpingColors.neutral500,
    neutral600: UnpingColors.neutral600,
    neutral700: UnpingColors.neutral700,
    neutral800: UnpingColors.neutral800,
    neutral900: UnpingColors.neutral900,
    neutral950: UnpingColors.neutral950,
    success25: UnpingColors.success25,
    success50: UnpingColors.success50,
    success100: UnpingColors.success100,
    success200: UnpingColors.success200,
    success300: UnpingColors.success300,
    success400: UnpingColors.success400,
    success500: UnpingColors.success500,
    success600: UnpingColors.success600,
    success700: UnpingColors.success700,
    success800: UnpingColors.success800,
    success900: UnpingColors.success900,
    success950: UnpingColors.success950,
    warning25: UnpingColors.warning25,
    warning50: UnpingColors.warning50,
    warning100: UnpingColors.warning100,
    warning200: UnpingColors.warning200,
    warning300: UnpingColors.warning300,
    warning400: UnpingColors.warning400,
    warning500: UnpingColors.warning500,
    warning600: UnpingColors.warning600,
    warning700: UnpingColors.warning700,
    warning800: UnpingColors.warning800,
    warning900: UnpingColors.warning900,
    warning950: UnpingColors.warning950,
    error25: UnpingColors.error25,
    error50: UnpingColors.error50,
    error100: UnpingColors.error100,
    error200: UnpingColors.error200,
    error300: UnpingColors.error300,
    error400: UnpingColors.error400,
    error500: UnpingColors.error500,
    error600: UnpingColors.error600,
    error700: UnpingColors.error700,
    error800: UnpingColors.error800,
    error900: UnpingColors.error900,
    error950: UnpingColors.error950,
    border: UnpingColors.border,
    divider: UnpingColors.divider,
    outline: UnpingColors.outline,
    textPrimary: UnpingColors.textPrimary,
    textSecondary: UnpingColors.textSecondary,
    textTertiary: UnpingColors.textTertiary,
    textDisabled: UnpingColors.textDisabled,
  );

  static const dark = UnpingColorExtension(
    primary25: UnpingColors.primary950,
    primary50: UnpingColors.primary950,
    primary100: UnpingColors.primary900,
    primary200: UnpingColors.primary800,
    primary300: UnpingColors.primary700,
    primary400: UnpingColors.primary600,
    primary500: UnpingColors.primary500,
    primary600: UnpingColors.primary400,
    primary700: UnpingColors.primary300,
    primary800: UnpingColors.primary200,
    primary900: UnpingColors.primary100,
    primary950: UnpingColors.primary50,
    neutral25: UnpingColors.neutral950,
    neutral50: UnpingColors.neutral950,
    neutral100: UnpingColors.neutral900,
    neutral200: UnpingColors.neutral800,
    neutral300: UnpingColors.neutral700,
    neutral400: UnpingColors.neutral600,
    neutral500: UnpingColors.neutral500,
    neutral600: UnpingColors.neutral400,
    neutral700: UnpingColors.neutral300,
    neutral800: UnpingColors.neutral200,
    neutral900: UnpingColors.neutral100,
    neutral950: UnpingColors.neutral50,
    success25: UnpingColors.success950,
    success50: UnpingColors.success950,
    success100: UnpingColors.success900,
    success200: UnpingColors.success800,
    success300: UnpingColors.success700,
    success400: UnpingColors.success600,
    success500: UnpingColors.success500,
    success600: UnpingColors.success400,
    success700: UnpingColors.success300,
    success800: UnpingColors.success200,
    success900: UnpingColors.success100,
    success950: UnpingColors.success50,
    warning25: UnpingColors.warning950,
    warning50: UnpingColors.warning950,
    warning100: UnpingColors.warning900,
    warning200: UnpingColors.warning800,
    warning300: UnpingColors.warning700,
    warning400: UnpingColors.warning600,
    warning500: UnpingColors.warning500,
    warning600: UnpingColors.warning400,
    warning700: UnpingColors.warning300,
    warning800: UnpingColors.warning200,
    warning900: UnpingColors.warning100,
    warning950: UnpingColors.warning50,
    error25: UnpingColors.error950,
    error50: UnpingColors.error950,
    error100: UnpingColors.error900,
    error200: UnpingColors.error800,
    error300: UnpingColors.error700,
    error400: UnpingColors.error600,
    error500: UnpingColors.error500,
    error600: UnpingColors.error400,
    error700: UnpingColors.error300,
    error800: UnpingColors.error200,
    error900: UnpingColors.error100,
    error950: UnpingColors.error50,
    border: UnpingColors.neutral800,
    divider: UnpingColors.neutral900,
    outline: UnpingColors.neutral700,
    textPrimary: UnpingColors.neutral50,
    textSecondary: UnpingColors.neutral400,
    textTertiary: UnpingColors.neutral600,
    textDisabled: UnpingColors.neutral700,
  );
